...
| A highly detailed, scalable, spatially explicit agent-based model for African swine fever (ASF) management. | ![image-right](/assets/images/InteractionMap1.png){: .align-right width="50%"}|